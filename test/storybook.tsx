import { Dropdown, TextInput, SpaceForm, CheckboxGroup, OutlinedButton, BaseButton, MaterialButton, IconButton, AllTheme, CartIcon, DownIcon, PositionBox, Breadcrumbs, Modal, RatingsBar, Footer, Header, ThemeToggle, SpaceLayoutFixed, SpaceLayoutFull } from "../src/solgaleo.index";
...
export function Storybook() {
    ...
    // return <SpaceLayoutFixed title='Storybook'
    //     header={<Header rightChildren={<ThemeToggle />} />}
    //     footer={<Footer />}
    // ></SpaceLayoutFixed>


    // return <SpaceLayoutFull title='Storybook'
    //     header={<Header rightChildren={<ThemeToggle />} />}
    //     footer={<Footer />}
    // ></SpaceLayoutFull>
    ...
    return (
        ...
        <SpaceLayoutFixed title='Storybook'
            header={<Header rightChildren={<ThemeToggle />} />}
            footer={<Footer />}
        >

...
export function CopyIcon({ props }: { props?: IconProps }) {
    ...
    return <svg viewBox="0 0 64 64" {...toProp(props)} fill="currentColor">
        <path d="M54 9h-4V5q-1-5-5-5H10Q5 0 5 5v47q0 5 5 5h6v2q0 5 5 5h33q5 0 5-5V14q0-5-5-5M7 52V5q1-3 3-3h35q2 0 3 3v47q-1 3-3 3H10q-2 0-3-3m50 7q0 3-3 3H21q-2 0-3-3v-2h27q4 0 5-5V11h4q3 0 3 3z" /><path d="M39 13H16a1 1 0 1 0 0 2h23a1 1 0 1 0 0-2m0 8H16a1 1 0 1 0 0 2h23a1 1 0 1 0 0-2m0 8H16a1 1 0 1 0 0 2h23a1 1 0 1 0 0-2m-11 9H16a1 1 0 1 0 0 2h12a1 1 0 1 0 0-2" />
    </svg>
}

...
export const CssSRC = {
    ...
    varSurfaceTint: "--surface-tint",
    varDisabled: "--disabled",
    varDisabledBg: "--disabled-bg",
    ...
    varSpacing: "--spacing",
    varBorder: "--border",
    varButtonPadding: "--button-padding",
    varIconPadding: "--icon-padding",
    varPrimaryBorder: "--primary-border",
    varError: "--error",
    varErrorBg: "--error-bg",
    varActive: "--active",
    varActiveBg: "--active-bg",
    varModalBg: "--modal-bg",
